function lge() {
    ...
    this.play = function () {
        ...
        if (video.playState == 0 || video.playState == 5) {
            ...
            video.play(1);
            $("#playBtn > img").remove();
            $('#playBtn').append('<img src="assets/images/video_ui/images/player_btn_icon/movie_btn_icon_pause_n.png" alt="pauseImg" class="playBtn" align="center" />');
        }
        if (video.playState == 2) {
            ...
            video.play(0);
            $("#playBtn > img").remove();
            $('#playBtn').append('<img src="assets/images/video_ui/images/player_btn_icon/movie_btn_icon_play_n.png" alt="playImg" class="playBtn" align="center" />');
        }
